...
Blockly.Python.forBlock["test001"] = function (block, generator){
  const _index = block.getFieldValue("servoIndex")
  return `magos.test(${_index})`
};
...
Blockly.Python.forBlock["play_audio"] = function (block, generator) {
...
Blockly.Python.forBlock["change_emoji"] = function (block, generator) {
  const _index = block.getFieldValue("emoji_index");
  return `magos.change_emoji(${_index})\n`;
};
Blockly.Python.forBlock["magos_time"] = function (block, generator) {
